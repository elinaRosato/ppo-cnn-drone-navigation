"""
Training launcher — v4 (GPS-free, monocular depth estimation).
...
def main():
    parser = argparse.ArgumentParser(description="Launch v4 training pipeline")
    ...
    print("=" * 60)
    print("PPO-CNN Drone Navigation v4 — GPS-Free Avoidance Launcher")
    print("=" * 60)
    print()
    ...
    run_bg(f"tensorboard --logdir={os.path.join(SCRIPT_DIR, '../../logs_v4')} --port=6006")
    time.sleep(2)
