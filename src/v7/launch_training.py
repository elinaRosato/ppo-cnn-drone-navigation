...
def main():
    parser = argparse.ArgumentParser(description="Launch v7 training pipeline")
    ...
    print("=" * 60)
    print("PPO-CNN Drone Navigation v7 — GPS-Free Avoidance Launcher")
    print("=" * 60)
    print()
    ...
    run_bg(f"tensorboard --logdir={os.path.join(SCRIPT_DIR, '../../logs_v7')} --port=6006")
    time.sleep(2)
